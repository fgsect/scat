...
class TestSdmEdgeParser(unittest.TestCase):
    ...
    def test_sdm_edge_scell_info(self):
        ...
        packet = sdmcmd.generate_sdm_packet(0xa0, sdmcmd.sdm_command_group.CMD_EDGE_DATA, sdmcmd.sdm_edge_data.EDGE_PHY_SCELL_INFO, payload, timestamp=0x0)
    ...
    def test_sdm_edge_ncell_info(self):
        ...
        packet = sdmcmd.generate_sdm_packet(0xa0, sdmcmd.sdm_command_group.CMD_EDGE_DATA, sdmcmd.sdm_edge_data.EDGE_PHY_NCELL_INFO, payload, timestamp=0x0)
...
EDGE Neighbor Cell Info: Neighbor Cell 9: ARFCN: 53, RxLev: 22 (RSSI: -88)'''}
    ...
    def test_sdm_edge_3g_ncell_info(self):
        ...
        packet = sdmcmd.generate_sdm_packet(0xa0, sdmcmd.sdm_command_group.CMD_EDGE_DATA, sdmcmd.sdm_edge_data.EDGE_PHY_3G_NCELL_INFO, payload, timestamp=0x0)
...
NCell 9: UARFCN: 10836, PSC: 261, RSSI: 1, RSCP: -107, Ec/No: -24.0'''}
    ...
    def test_sdm_edge_handover_info(self):
        ...
        packet = sdmcmd.generate_sdm_packet(0xa0, sdmcmd.sdm_command_group.CMD_EDGE_DATA, sdmcmd.sdm_edge_data.EDGE_PHY_HO_INFO, payload, timestamp=0x0)
    ...
    def test_sdm_edge_handover_history_info(self):
        ...
        packet = sdmcmd.generate_sdm_packet(0xa0, sdmcmd.sdm_command_group.CMD_EDGE_DATA, sdmcmd.sdm_edge_data.EDGE_PHY_HO_HISTORY_INFO, payload, timestamp=0x0)
    ...
    def test_sdm_edge_meas_info(self):
        ...
        packet = sdmcmd.generate_sdm_packet(0xa0, sdmcmd.sdm_command_group.CMD_EDGE_DATA, sdmcmd.sdm_edge_data.EDGE_PHY_MEAS_INFO, payload, timestamp=0x0)
