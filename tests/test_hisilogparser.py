...
class TestHisiLogParser(unittest.TestCase):
    ...
    def test_parse_hisi_lte_ota_msg(self):
        ...
        expected = {'cp': [binascii.unhexlify('02040d000000000000000000040000006a9000')],
            'layer': 'rrc'}
        ...
        result = self.parser.hisi_lte_ota_msg(payload[1:25], payload[25:], None)
        expected = {'cp': [binascii.unhexlify('02040d0000000000000000000500000040498805bfcd0322f0382130a0818c4326c0')],
            'layer': 'rrc'}
        self.assertDictEqual(result, expected)
        ...
        result = self.parser.hisi_lte_ota_msg(payload[1:25], payload[25:], None)
        expected = {'cp': [binascii.unhexlify('02040d0000000000000000000500000000801c31186fe292f836059662d001040050ee596aa12f39af763030a841bfc83aa4749e00')],
            'layer': 'rrc'}
        self.assertDictEqual(result, expected)
        ...
        result = self.parser.hisi_lte_ota_msg(payload[1:25], payload[25:], None)
        expected = {'cp': [binascii.unhexlify('02040d00000000000000000005000000010c060591104c6acc0884d288c030a519a57180614a334ba300c294625244000689e268982588c22886200761c86e1a0171ff00e75a8010ff00e70000')],
            'layer': 'rrc'}
        self.assertDictEqual(result, expected)
        ...
        result = self.parser.hisi_lte_ota_msg(payload[1:25], payload[25:], None)
        expected = {'cp': [binascii.unhexlify('02040d0000000000000000000600000040065cbcdb0fd0')],
            'layer': 'rrc'}
        self.assertDictEqual(result, expected)
        ...
        result = self.parser.hisi_lte_ota_msg(payload[1:25], payload[25:], None)
        expected = {'cp': [binascii.unhexlify('02040d0000000000000000000000000068129808fdce0183b0ba083e8bff44ae618531b3806009420a1a004220')],
            'layer': 'rrc'}
        self.assertDictEqual(result, expected)
        ...
        result = self.parser.hisi_lte_ota_msg(payload[1:25], payload[25:], None)
        expected = {'cp': [binascii.unhexlify('02040d00000000000000000002000000465cb8470a08')],
            'layer': 'rrc'}
        self.assertDictEqual(result, expected)
        ...
        result = self.parser.hisi_lte_ota_msg(payload[1:25], payload[25:], None)
        expected = {'cp': [binascii.unhexlify('02040d00000000000000000001000000320220')],
            'layer': 'rrc'}
        self.assertDictEqual(result, expected)
        ...
        result = self.parser.hisi_lte_ota_msg(payload[1:25], payload[25:], None)
        expected = {'cp': [binascii.unhexlify('02040d000000000000000000010000002202353811fb9c0327603ea06d01d875141d8bc5bba480241a0190003f00')],
            'layer': 'rrc'}
        self.assertDictEqual(result, expected)
        ...
        result = self.parser.hisi_lte_ota_msg(payload[1:25], payload[25:], None)
        expected = {'cp': [binascii.unhexlify('')],
            'layer': 'rrc'}
        self.assertDictEqual(result, expected)

        payload = binascii.unhexlify('000220010362140000F604AE00000000000000012014000000AB000000010000000A000000DA0F0000013A0040')
        result = self.parser.hisi_lte_ota_msg(payload[1:25], payload[25:], None)
        expected = {'cp': [binascii.unhexlify('02040d000000000000000000010000003a0040')],
            'layer': 'rrc'}
        self.assertDictEqual(result, expected)
        ...
        result = self.parser.hisi_lte_ota_msg(payload[1:25], payload[25:], None)
        expected = {'cp': [binascii.unhexlify('02040d000000000000000000030000002200262F24A4A060040E98C00BE99708E140AE044000')],
            'layer': 'rrc'}
        self.assertDictEqual(result, expected)

        payload = binascii.unhexlify('0002200103C61200004D02AE00000000000000012013000000AB0000000200000007000000D60F0000022A00')
        result = self.parser.hisi_lte_ota_msg(payload[1:25], payload[25:], None)
        expected = {'cp': [binascii.unhexlify('02040d000000000000000000030000002a00')],
            'layer': 'rrc'}
        self.assertDictEqual(result, expected)

        payload = binascii.unhexlify('00022001039F1300004A03AE00000000000000012013000000AB0000000200000009000000CB0F0000021200')
        result = self.parser.hisi_lte_ota_msg(payload[1:25], payload[25:], None)
        expected = {'cp': [binascii.unhexlify('02040d000000000000000000030000001200')],
            'layer': 'rrc'}
        self.assertDictEqual(result, expected)
        ...
        result = self.parser.hisi_lte_ota_msg(payload[1:25], payload[25:], None)
        expected = {'cp': [binascii.unhexlify('02040d000000000000000000030000003a0116540004360c8a1541a950aa23820d112000600046384251cfba167a6bb7284a39f742cf4d76f509473ee859e9aedb8000659f188213871eba1a167a6bb6800c80e80ead3000036125ed2200dbb8500851a3d3c680428d1e9eb4021468f4ff0a010a347a7b8000')],
            'layer': 'rrc'}
        self.assertDictEqual(result, expected)

        payload = binascii.unhexlify('0002200103111700003161AE00000000000000012015000000AB000000020000000E000000C70F0000020800A530')
        result = self.parser.hisi_lte_ota_msg(payload[1:25], payload[25:], None)
        expected = {'cp': [binascii.unhexlify('02040d000000000000000000030000000800a530')],
            'layer': 'rrc'}
        self.assertDictEqual(result, expected)
        ...
        result = self.parser.hisi_lte_ota_msg(payload[1:25], payload[25:], None)
        expected = {'cp': [binascii.unhexlify('020412000000000000000000000000000741620BF662F220EEAD65CB8470A004F0F0C0C000200201D011271A8080211001010010810600000000830600000000000A00000D005262F220BFCD5C20003103E560349011035758865D0100E0')],
            'layer': 'nas'}
        self.assertDictEqual(result, expected)
        ...
        result = self.parser.hisi_lte_ota_msg(payload[1:25], payload[25:], None)
        expected = {'cp': [binascii.unhexlify('02041200000000000000000000000000075503')],
            'layer': 'nas'}
        self.assertDictEqual(result, expected)
