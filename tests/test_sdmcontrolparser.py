...
class TestSdmControlParser(unittest.TestCase):
    ...
    def test_sdm_control_start_response(self):
        ...
        expected = {'stdout': 'SDM Start Response: Version: LibVer: 720626002800, ASN: LTE Release 16.7.0 (21.12), NR Release 16.7.0 (21.12), ICD: 7.2, Date: 2022-10-27T23:21-0700, Extra: g5300g-220923-221028-B-9229469;;3bff1a13fafb47;de_o2;wildcard, ID: 0x5300'}
        ...
        result = self.parser.sdm_control_start_response(payload)
        expected = {'stdout': 'SDM Start Response: Version: LibVer: 720624000000, ASN: LTE Release 15.12.0 (20.12), NR Release 15.9.0 (20.03), ICD: 7.0, Date: Feb 27 2023 07:42:31, Extra: S901BXXU3CWBE, ID: 0x5133'}
        ...
        result = self.parser.sdm_control_start_response(payload)
        expected = {'stdout': 'SDM Start Response: Version: LibVer: 04002c000400, ASN: LTE Release 15.12.0 (20.12), NR Release 15.9.0 (20.03), ICD: 6.22, Date: Dec 25 2021 13:44:12, Extra: g5123b-93368-211225-B-8029609;cfgdb-wc-211225-B-8029609;05126113fafb47;n/a;n/a, ID: 0x5123'}
        self.assertDictEqual(result, expected)
        ...
        result = self.parser.sdm_control_start_response(payload)
        expected = {'stdout': 'SDM Start Response: Version: LibVer: 010000000000, ASN: LTE Release 16.2.0 (20.09), NR Release 15.9.0 (20.03), ICD: 6.22, Date: Oct 17 2022 01:52:44, Extra: G991NKOU3DVJ8, ID: 0x5123a'}
        self.assertDictEqual(result, expected)
        self.assertTupleEqual(self.parser.icd_ver, (6, 22))
