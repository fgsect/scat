...
└── Cell 1: PCI:  487, PBCH SFN: 474, RSRP: -117.24, RSRQ: -14.58, Num Beams: 1
    ...
    def test_parse_nr_mib_info(self):
        ...
        result = self.parser.parse_nr_mib_info(pkt_header, payload, dict())
        expected = {
    ...
    def test_parse_nr_rrc_scell_info(self):
        ...
        result = self.parser.parse_nr_rrc_scell_info(pkt_header, payload, dict())
        expected = {
    ...
    def test_parse_nr_rrc(self):
        ...
        # result = self.parser.parse_nr_rrc(pkt_header, payload, dict())
        # expected = {
        # }
        # self.assertDictEqual(result, expected) # type: ignore
    ...
    def test_parse_nr_mm_state(self):
        ...
        result = self.parser.parse_nr_mm_state(pkt_header, payload, dict())
        expected = {
